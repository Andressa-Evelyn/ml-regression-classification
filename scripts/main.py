...
# balanceamento para classificação
from models.bayers import random_oversampling
Xc, yc = random_oversampling(Xc, yc)
...
# Euclidiana
res_euc, t_tr_euc, t_te_euc = kfold_knn(Xc, yc, k_folds=5, k_vizinhos=5, distancia_func=distancia_euclidiana)
...
# Manhattan
res_man, t_tr_man, t_te_man = kfold_knn(Xc, yc, k_folds=5, k_vizinhos=5, distancia_func=distancia_manhattan)
...
# UNIVARIADO
accs_uni, precs_uni, rcs_uni, f1s_uni, t_train_uni, t_test_uni = avaliar_kfold(Xc, yc, k=5, tipo="uni")
...
# MULTIVARIADO
accs_multi, precs_multi, rcs_multi, f1s_multi, t_train_multi, t_test_multi = avaliar_kfold(Xc, yc, k=5, tipo="multi")
...
res_knn_reg, t_tr_knn, t_te_knn = kfold_knn_regressao(
    Xr, yr, k_folds=5, k_vizinhos=5, distancia_func=distancia_euclidiana
)
...
# Regressão Linear
res_lin, t_tr_lin, t_te_lin = kfold_regressao_linear(Xr, yr, k=5)
